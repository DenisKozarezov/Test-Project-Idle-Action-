...
public partial class GameEntity {
    ...
    public Core.ECS.Components.SpriteRendererComponent spriteRenderer { get { return (Core.ECS.Components.SpriteRendererComponent)GetComponent(GameComponentsLookup.SpriteRenderer); } }
    ...
    public void AddSpriteRenderer(UnityEngine.SpriteRenderer newValue) {
        ...
        var component = (Core.ECS.Components.SpriteRendererComponent)CreateComponent(index, typeof(Core.ECS.Components.SpriteRendererComponent));
