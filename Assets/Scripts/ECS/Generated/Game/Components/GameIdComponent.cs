...
public partial class GameEntity {
    ...
    public Core.ECS.Components.Id id { get { return (Core.ECS.Components.Id)GetComponent(GameComponentsLookup.Id); } }
    ...
    public void AddId(int newValue) {
        ...
        var component = (Core.ECS.Components.Id)CreateComponent(index, typeof(Core.ECS.Components.Id));
