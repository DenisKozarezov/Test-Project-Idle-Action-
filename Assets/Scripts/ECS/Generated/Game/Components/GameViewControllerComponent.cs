...
public partial class GameEntity {
    ...
    public Core.ECS.Components.ViewControllerComponent viewController { get { return (Core.ECS.Components.ViewControllerComponent)GetComponent(GameComponentsLookup.ViewController); } }
    ...
    public void AddViewController(Core.ECS.ViewListeners.IViewController newValue) {
        ...
        var component = (Core.ECS.Components.ViewControllerComponent)CreateComponent(index, typeof(Core.ECS.Components.ViewControllerComponent));
