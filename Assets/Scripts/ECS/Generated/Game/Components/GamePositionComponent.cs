...
public partial class GameEntity {
    ...
    public Core.ECS.Components.Position position { get { return (Core.ECS.Components.Position)GetComponent(GameComponentsLookup.Position); } }
    ...
    public void AddPosition(UnityEngine.Vector3 newValue) {
        ...
        var component = (Core.ECS.Components.Position)CreateComponent(index, typeof(Core.ECS.Components.Position));
