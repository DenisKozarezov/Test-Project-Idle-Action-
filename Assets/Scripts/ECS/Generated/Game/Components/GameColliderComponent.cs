...
public partial class GameEntity {
    ...
    public Core.ECS.Components.ColliderComponent collider { get { return (Core.ECS.Components.ColliderComponent)GetComponent(GameComponentsLookup.Collider); } }
    ...
    public void AddCollider(UnityEngine.Collider newValue) {
        ...
        var component = (Core.ECS.Components.ColliderComponent)CreateComponent(index, typeof(Core.ECS.Components.ColliderComponent));
