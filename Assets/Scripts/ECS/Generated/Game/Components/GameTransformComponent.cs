...
public partial class GameEntity {
    ...
    public Core.ECS.Components.TransformComponent transform { get { return (Core.ECS.Components.TransformComponent)GetComponent(GameComponentsLookup.Transform); } }
    ...
    public void AddTransform(UnityEngine.Transform newValue) {
        ...
        var component = (Core.ECS.Components.TransformComponent)CreateComponent(index, typeof(Core.ECS.Components.TransformComponent));
